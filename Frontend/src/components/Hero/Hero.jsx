...
function Hero() {
  const words = ["Movies", "Events", "Sports", "Concerts", "Theater"];
  ...
  return (
    <>
      <section className="relative flex mb-2 items-center justify-center h-screen text-white bg-center bg-cover bg-[url('/header12.jpg')]">
