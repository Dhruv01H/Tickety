  ...
  return (
    <div className="flex flex-col w-full lg:flex-row">
      {movies.map((movie) => (
        ...
        >
          <div className="absolute inset-0 transition-opacity duration-300 bg-black/50 hover:opacity-30"></div>
          ...
          <div className="relative flex flex-col items-center">
            <div className="p-7 text-primary  text-5xl bg-frost rounded-[50%] hover:text-frost hover:bg-primary transition-all duration-500"><i className={`${movie.icon}`}></i></div>
