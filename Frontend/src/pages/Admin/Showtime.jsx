...
function Showtime() {
  return (
    <>
      <div className="p-6">
      <h2 className="mb-6 text-3xl font-semibold text-pink-600">Add Showtime</h2>
      <form className="max-w-3xl">
        <div className="mb-4">
          <label className="block mb-2 font-medium text-gray-700" htmlFor="screen">
            Screen Number
          </label>
          <input
            type="number"
        ...
        <div className="mb-4">
          <label className="block mb-1 font-medium text-gray-700" htmlFor="date">
            Date
          </label>
          <input
            type="date"
        ...
        <div className="mb-4">
          <label className="block mb-1 font-medium text-gray-700" htmlFor="time">
            Time
          </label>
          <input
            type="time"
        ...
        <div className="mb-6">
          <label className="block mb-1 font-medium text-gray-700" htmlFor="format">
            Movie Format
          </label>
          <select
            id="format"
